...
if __name__ == "__main__":
    ...
    print("The count of the DF is : "+ infer_DF.count())
    ...
    print("The count of the DF is : "+ infer_DF.count()+ struc_Divvy_DF.count())
    ...
    DDL_Df.show()
    DDL_Df.printSchema()
    print("The count of the DF is : "+ infer_DF.count()+  DDL_Df.count())
